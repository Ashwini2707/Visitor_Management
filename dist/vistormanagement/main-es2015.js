...
const routes = [
    ...
    {
        path: 'user',
        loadChildren: () => Promise.all(/*! import() | user-user-module */[__webpack_require__.e("common"), __webpack_require__.e("user-user-module")]).then(__webpack_require__.bind(null, /*! ./user/user.module */ "./src/app/user/user.module.ts")).then(m => m.UserModule)
    },
    {
        path: 'manager',
        loadChildren: () => __webpack_require__.e(/*! import() | manager-manager-module */ "manager-manager-module").then(__webpack_require__.bind(null, /*! ./manager/manager.module */ "./src/app/manager/manager.module.ts")).then(m => m.ManagerModule)
    }
];
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_5__["AngularFireModule"].initializeApp(environment.firebase),
...
module.exports = __webpack_require__(/*! C:\Users\veers\Desktop\sir project\src\main.ts */"./src/main.ts");
