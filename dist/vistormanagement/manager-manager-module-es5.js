...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["manager-manager-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppManagerMangerdashboardMangerdashboardComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppManagerManagerRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _mangerdashboard_mangerdashboard_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./mangerdashboard/mangerdashboard.component */
  ...
  function srcAppManagerManagerModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _manager_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./manager-routing.module */
    "./src/app/manager/manager-routing.module.ts");
    /* harmony import */


    var _mangerdashboard_mangerdashboard_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./mangerdashboard/mangerdashboard.component */
    "./src/app/manager/mangerdashboard/mangerdashboard.component.ts");
    /* harmony import */


    var _showpipe_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./showpipe.pipe */
    ...
    ManagerModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _manager_routing_module__WEBPACK_IMPORTED_MODULE_3__["ManagerRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"]]
    })], ManagerModule);
    /***/
  },
  ...
  /***/
  function srcAppManagerManagerServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function () {
      ...
      _createClass(ManagerService, [{
        ...
        key: "updateVisit",
        value: function updateVisit(v) {
          console.log(v);
          return this.db.doc("visits/".concat(v.id)).update(v);
        }
      }]);
  ...
  /***/
  function srcAppManagerMangerdashboardMangerdashboardComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppManagerMangerdashboardMangerdashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MangerdashboardComponent", function () {
      return MangerdashboardComponent;
    });
    /* harmony import */
    ...
    var _manager_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../manager.service */
    "./src/app/manager/manager.service.ts");
    /* harmony import */
    ...
    var MangerdashboardComponent =
    /*#__PURE__*/
    function () {
      function MangerdashboardComponent(ms, router) {
        _classCallCheck(this, MangerdashboardComponent);

        this.ms = ms;
        this.router = router;
      }

      _createClass(MangerdashboardComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.ms.getVisits().subscribe(function (res) {
            _this.visits = res;
        ...
        key: "visited",
        value: function visited(v) {
          v.status = 'done';
          this.ms.updateVisit(v).then(function (res) {
            console.log(res);
          });
        }
      }, {
    ...
    MangerdashboardComponent.ctorParameters = function () {
      return [{
    ...
    MangerdashboardComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-mangerdashboard',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./mangerdashboard.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/manager/mangerdashboard/mangerdashboard.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./mangerdashboard.component.css */
      "./src/app/manager/mangerdashboard/mangerdashboard.component.css")).default]
  ...
  /***/
  function srcAppManagerShowpipePipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ShowpipePipe", function () {
      return ShowpipePipe;
    });
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function ShowpipePipe() {
        _classCallCheck(this, ShowpipePipe);
      }

      _createClass(ShowpipePipe, [{
        key: "transform",
        value: function transform(value) {
          ...
          var ar = value.map(function (a) {
            return JSON.stringify(a);
          });
          var res = ar.filter(function (a) {
            if (a.indexOf(args) != -1) {
              return true;
            }
          });
    ...
    ShowpipePipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
      name: 'showpipe'
    })], ShowpipePipe);
    /***/
  }
